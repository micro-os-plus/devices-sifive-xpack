...
- name the post like: **µOS++ devices-sifive v2.0.0 released**
...
- `npm dist-tag add @xpack-sifive/devices@2.0.0 latest`
- `npm dist-tag ls @@xpack-sifive/devices`
...
- paste the release name like **µOS++ devices-sifive v2.0.0 released**
