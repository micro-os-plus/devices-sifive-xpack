...
- name the file like `2020-12-19-devices-sifive-v0-1-0-released.md`
- name the post like: **µOS++ devices-sifive v1.0.3 released**
...
- commit all changes
- update `CHANGELOG.md`; commit with a message like _CHANGELOG: prepare v1.0.3_
...
- `npm dist-tag add @xpack-sifive/devices@1.0.3 latest`
- `npm dist-tag ls @@xpack-sifive/devices`
...
- paste the release name like **µOS++ devices-sifive v1.0.3 released**
