...
- name the post like: **µOS++ devices-sifive v1.1.0 released**
...
- `npm dist-tag add @xpack-sifive/devices@1.1.0 latest`
- `npm dist-tag ls @@xpack-sifive/devices`
...
- paste the release name like **µOS++ devices-sifive v1.1.0 released**
